...
@section('content')
    <form class="form" method="POST" action="{{url('/comunicado-nascimento')}}">
        {{csrf_field()}}
        ...
        <div class="form-group row">
            <label for="nascimento" class="col-4 col-form-label">Quantidade de nascidos:</label>
            <div class="col-8">
                <input id="nascimento" name="nascimento" placeholder="Insira a Quantidade de Nascidos" type="text" required="required" class="form-control">
            </div>
        </div>
